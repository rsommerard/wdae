...
docker kill $(docker ps | grep "rsommerard/helloweave" | awk '{ print $1; }')
...
docker rm -f $(docker ps | grep "rsommerard/helloweave" | awk '{ print $1; }')
...
docker rmi -f $(docker images | grep "rsommerard/helloweave" | awk '{ print $3; }')
